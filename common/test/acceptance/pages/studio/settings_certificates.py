...
class Certificate(object):
    ...
    def signatories(self):
        ...
        return [Signatory(self, self.selector, index) for index in xrange(len(self.page.q(css=css)))]
...
class Signatory(object):
    ...
    def __init__(self, certificate, prefix, index):
        ...
        self.selector = prefix + ' .signatory-edit-view-{}'.format(index)
        self.index = index
    ...
    def name(self):
        ...
        """
        return self.find_css('.signatory-panel-body .signatory-field-label').first.text[0]
    ...
    def title(self):
        ...
        """
        return self.find_css('.signatory-panel-body .signatory-field-value').first.text[0]
    ...
    def edit(self):
        ...
        """
        self.find_css('.action-edit-signatory').first.click()
    ...
    def save(self):
        ...
        Save signatory.
        """
        self.find_css('.action-button-text').first.click()
